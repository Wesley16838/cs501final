...
public class Summary extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CardView referral = (CardView) v.findViewById(R.id.referral);
        if(status.equals("Student")){
            referral.setVisibility(View.GONE);
        }
        TextView head = (TextView) v.findViewById(R.id.headline);
        TextView summary = (TextView) v.findViewById(R.id.summary);

        String headline = preferences.getString("headline","");
        String sum = preferences.getString("summary","");
